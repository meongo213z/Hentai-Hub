...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Thống kê", Icon = "plus-circle" }),
    ...
    Raid = Window:AddTab({ Title = "Ngục tối", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Lấy V4", Icon = "chevrons-right" }),
...
ImageButton.Image = "rbxassetid://16150314633"
